...
(() => {
  ...
  const translations = {
    fa: {
      ...
      'hero.eyebrow': 'طراح گرافیک و تولید کننده محتوای تبلیغاتی',
      'hero.titleSmall': 'از ایده تا تصویر نهایی',
      'hero.titleBig': '<span class="latin">Neda Visuals</span>',
      'hero.subtitle': 'ساخت تبلیغات بصری، تدوین و ادیت<br>طراحی، گرافیک، چاپ، انیمیشن<br>با یه ظاهر حرفه‌ای، بیشتر دیده شو و بیشتر بفروش',
      ...
      'gallery.filter.animation': 'انیمیشن و تدوین',
      ...
      'gallery.items.logo-zwjikram-htwrq-aee-viiclncab-y0f-42a9c8.title': 'برند بانو',
      'gallery.items.logo-poster-f87a50.title': 'برند بلک',
      ...
      'contact.name': 'ندا',
      'contact.role': 'طراح گرافیک و تولید کننده محتوای تبلیغاتی',
    ...
    en: {
      ...
      'hero.titleBig': '<span class="latin">Neda Visuals</span>',
      'hero.subtitle': 'AI Creator<br>design, graphics, print, animation<br>With a professional appearance, be seen more and sell more',
      ...
      'gallery.filter.animation': 'Animation & Motion Graphics',
      ...
      'gallery.items.logo-zwjikram-htwrq-aee-viiclncab-y0f-42a9c8.title': 'banoo brand',
      'gallery.items.logo-poster-f87a50.title': 'black brand',
    ...
    ar: {
      ...
      'hero.titleBig': '<span class="latin">Neda Visuals</span>',
      'hero.subtitle': 'مبدعة الذكاء الاصطناعي<br>تصميم، الجرافيك، الطباعة، الرسوم المتحركة الدعائية<br>بمظهر احترافي، كن أكثر رؤية وازدهر بالمبيعات',
      ...
      'gallery.filter.animation': 'الرسوم المتحركة والمونتاج',
      ...
      'gallery.items.logo-zwjikram-htwrq-aee-viiclncab-y0f-42a9c8.title': 'علامه بانو',
      'gallery.items.logo-poster-f87a50.title': 'علامه بلک',
